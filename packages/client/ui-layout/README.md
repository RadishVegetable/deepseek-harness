...
The layout root is intentionally profile-neutral. Tavern owns its complete browser root in `ui-tavern-app`; this package does not inspect document attributes or mount a second Tavern surface above the conversation.
