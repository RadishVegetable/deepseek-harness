 ...
 * set is active: the active profile owns the built-in 'root' slot and the
 * shell's render is the one ctx-level renderSlot call in the program.
 */
...
/** Assembly inputs: the active app-shell context with slots and sessions. */
