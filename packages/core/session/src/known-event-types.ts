...
export const KNOWN_SESSION_EVENT_TYPES: ReadonlySet<string> = new Set([
  ...
  'step/start',
  'subagent/descriptor',
  'tavern/assets-edited',
  'tavern/assets-normalized',
  'tavern/assets-selected',
  'tavern/context-activation',
  'tavern/fact',
  'tavern/fact-search',
  'tavern/gm-response',
  'tavern/greeting',
  'tavern/memory-capability',
  'tavern/memory-cleanup',
  'tavern/memory-context',
  'tavern/memory-cursor',
  'tavern/memory-extraction',
  'tavern/memory-fork',
  'tavern/memory-revert',
  'tavern/section-config',
  'tavern/story-state',
  'tavern/swipe',
  'todo/write',
