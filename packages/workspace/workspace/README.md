...
- `ctx.workspaceRegistry.unarchiveSession(id)` — removes an archive marker and restores the Session to its prior workspace or Ungrouped projection. It is idempotent and rejects unknown sessions.
