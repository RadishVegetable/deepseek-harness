...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  conversationChatView: 'client-side shared Chat view service — packages/client/ui-conversation/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  AssetId: 'Tavern asset identity is owned by packages/tavern/assets/README.md',
  AssetSelection: 'Tavern asset selection contract is owned by packages/tavern/assets/README.md',
  CharacterAsset: 'Tavern character asset contract is owned by packages/tavern/assets/README.md',
  PromptAssetBaseline: 'Tavern prompt baseline contract is owned by packages/tavern/assets/README.md',
  CanonicalAssetView: 'Tavern canonical asset view is owned by packages/tavern/memory/README.md',
  TavernAssetCleaningPreview: 'Tavern asset-cleaning preview is owned by packages/tavern/host/README.md',
  TavernImportOptions: 'Tavern import options are owned by packages/tavern/host/README.md',
  TavernMemoryInspection: 'Tavern memory inspection result is owned by packages/tavern/host/README.md',
  TavernRegenerateInput: 'Tavern regeneration input is owned by packages/tavern/host/README.md',
  TavernRegenerateResult: 'Tavern regeneration result is owned by packages/tavern/host/README.md',
  TavernSectionConfigInput: 'Tavern section configuration input is owned by packages/tavern/host/README.md',
  TavernSectionConfigInspection: 'Tavern section configuration inspection is owned by packages/tavern/host/README.md',
  TavernSelectionInspection: 'Tavern selection inspection is owned by packages/tavern/host/README.md',
  TavernSessionSelection: 'Tavern session selection is owned by packages/tavern/host/README.md',
  TavernMessageEditInput: 'Tavern message edit input is owned by packages/tavern/host/README.md',
  TavernMessageEditResult: 'Tavern message edit result is owned by packages/tavern/host/README.md',
  TavernFactEditInput: 'Tavern fact edit input is owned by packages/tavern/host/README.md',
  TavernFactInspection: 'Tavern fact inspection is owned by packages/tavern/host/README.md',
  TavernFactProjection: 'Tavern fact projection is owned by packages/tavern/host/README.md',
  TavernFactRemovalInput: 'Tavern fact removal input is owned by packages/tavern/host/README.md',
  TavernBootstrapJourneyResult: 'Tavern bootstrap result is owned by packages/tavern/host/README.md',
  TavernGmResponseInspection: 'Tavern GM response inspection is owned by packages/tavern/host/README.md',
  TavernHistoryEntry: 'Tavern history summary is owned by packages/tavern/host/README.md',
  TavernJourneyAssetProjection: 'Tavern Journey asset projection is owned by packages/tavern/host/README.md',
  TavernUpdateOptions: 'Tavern asset update options are owned by packages/tavern/host/README.md',
  CompiledContext: 'Tavern context compilation is owned by docs/subsystems/tavern.md',
  PromptWorldInfoEntry: 'Tavern prompt World Info entries are owned by packages/tavern/assets/README.md',
  StoryStateChange: 'Tavern story-state change contract is owned by packages/tavern/state/README.md',
  WorldInfoAsset: 'Tavern World Info asset contract is owned by packages/tavern/assets/README.md',
  WebUpgradeRoute:
