...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-tavern': { kind: 'none', reason: 'Browser-side Tavern debug view; registers nothing model-facing.' },
  ...
  'packages/bundle/tavern': { kind: 'none', reason: 'The optional Web patch and browser debug view register nothing model-facing.' },
